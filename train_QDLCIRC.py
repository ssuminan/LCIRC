...
BATCH_SIZE_VALID = 1
PRE_CP_PATH = "/workspace/LCIRC/checkpoint_epoch0_final.pt"
...
parquet_files = ['/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_00.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_01.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_02.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_03.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_04.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_05.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_06.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_07.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_08.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_09.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_10.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_11.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_12.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_13.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_14.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_15.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_16.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_17.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_18.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_0_19.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_00.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_01.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_02.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_03.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_04.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_05.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_06.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_07.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_08.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_09.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_10.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_11.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_12.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_13.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_1_14.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_00.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_01.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_02.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_03.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_04.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_05.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_06.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_07.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_08.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_09.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_10.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_11.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_12.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_13.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_2_14.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_00.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_01.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_02.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_03.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_04.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_05.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_06.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_07.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_08.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_09.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_10.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_11.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_12.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_13.parquet',
                 '/workspace/NEW_QueryDependent_train_text/FineWebEdu_QA_3_14.parquet']

train_dataset = load_dataset('parquet', data_files=parquet_files, cache_dir="/workspace/test_cache_data_FineWebEdu")['train']
valid_dataset = load_dataset('parquet', data_files='/workspace/NEW_QueryDependent_valid_text/FineWebEdu_QA_0_00.parquet', cache_dir="/workspace/test_cache_data_FineWebEdu")['train']

with open("/workspace/NEW_QueryDependent_train_text/FineWebEdu_Answer_10000.json", 'r', encoding='utf-8') as file:
    train_answer_set = set(json.load(file))
with open("/workspace/NEW_QueryDependent_valid_text/FineWebEdu_Answer_valid.json", 'r', encoding='utf-8') as file:
        ...
        if (idx == 0 or (idx + 1) % 2000 == 0) and rank == 0:
            ...
            if (idx + 1) % 2000 == 0:
                if len(valid_loss_all) == 0:
                    CP_PATH = f'checkpoint_epoch{epoch}_{(idx + 1)}.pt'
                ...
                np.save(f"train_loss", np.array(train_loss_all))
                np.save(f"valid_loss", np.array(valid_loss_all))

            torch.cuda.empty_cache()

    if rank == 0:
        CP_PATH = f'checkpoint_epoch{epoch}_final.pt'
        torch.save({'Xattn_layers_state_dict': llama.module.model.Xattn_layers.state_dict(),
                    'compressor_state_dict': llama.module.compressor.state_dict(),
                    'mixer_state_dict': llama.module.mixer.state_dict(),
                    'latent_state_dict': {k: v for k, v in llama.module.state_dict().items() if k == "latent"},
